...
export class CatelogProductQuantity extends FloatField {
    setup() {
...
CatelogProductQuantity.props = {
    ...FloatField.props,
    hideButtons: { type: Boolean, optional: true }
};
CatelogProductQuantity.defaultProps = {
    ...FloatField.defaultProps,
    hideButtons: false,
};

CatelogProductQuantity.template = 'sale_catelog.CatelogProductQuantity';
CatelogProductQuantity.extractProps = (props) => {
    return {
...
registry.category('fields').add('catelog_product_quantity', CatelogProductQuantity);
